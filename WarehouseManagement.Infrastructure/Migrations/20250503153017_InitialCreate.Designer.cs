...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseManagement.Core.Entities.InventoryOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WarehouseManagement.Core.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WarehouseManagement.Core.Entities.InventoryOperation", b =>
                {
                    ...
                    b.HasOne("WarehouseManagement.Core.Entities.ApplicationUser", "User")
                        .WithMany("InventoryOperations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
